...
官方渠道销售，支持正品验证
透明尘杯可直接展示清洁结果
核心功能均有实拍素材证明</textarea></div><section class="trust-attachment-section" aria-label="背书附件"><div class="trust-attachment-head"><div><strong>背书附件 <small id="productTrustAttachmentCount">0</small></strong><span>不限格式，单个文件最大 50 MB</span></div><div><input id="productTrustAttachmentInput" type="file" multiple hidden><button class="soft-btn" type="button" id="productTrustAttachmentUpload">＋ 上传附件</button></div></div><div class="trust-attachment-list" id="productTrustAttachmentList"></div></section></div>
...
无法证明的竞品对比结论</textarea></div></div>
            ...
            <div class="pda-layer" id="pdaAssociateModal" hidden><div class="pda-modal pda-modal-lg pda-associate-modal" role="dialog" aria-modal="true"><header><div><small>关联资产</small><h3 id="pdaAssociateTitle">关联创作素材</h3></div><button type="button" data-pda-close="pdaAssociateModal">×</button></header><div class="pda-associate-toolbar" id="pdaAssociateToolbar"></div><div class="pda-modal-body pda-associate-body" id="pdaAssociateBody"><aside class="pda-associate-folders" id="pdaAssociateFolders"><strong>文件夹</strong><div class="pda-associate-folder-tree" id="pdaAssociateFolderTree"></div></aside><section class="pda-associate-results"><div class="pda-media-grid" id="pdaAssociateGrid"></div></section></div><footer><span id="pdaAssociateCount">已选择 0 项</span><div><button class="pda-btn" type="button" data-pda-close="pdaAssociateModal">取消</button><button class="pda-btn primary" id="pdaAssociateConfirm" type="button">确认关联</button></div></footer></div></div>
            <div class="pda-layer" id="pdaPersonaAssociateModal" hidden><div class="pda-modal pda-modal-lg pda-persona-associate-modal" role="dialog" aria-modal="true" aria-labelledby="pdaPersonaAssociateTitle"><header><div><small>关联模板</small><h3 id="pdaPersonaAssociateTitle">关联人群画像</h3><p>仅展示通用画像；关联后将绑定当前产品，不能再关联其他产品。</p></div><button type="button" data-pda-close="pdaPersonaAssociateModal">×</button></header><div class="pda-associate-toolbar"><label class="pda-search pda-associate-search"><span>⌕</span><input id="pdaPersonaAssociateSearch" type="search" placeholder="搜索画像名称、人群或场景"></label></div><div class="pda-modal-body pda-persona-associate-body"><div class="pda-persona-associate-grid" id="pdaPersonaAssociateList"></div></div><footer><span id="pdaPersonaAssociateCount">已选择 0 项</span><div><button class="pda-btn" type="button" data-pda-close="pdaPersonaAssociateModal">取消</button><button class="pda-btn primary" id="pdaPersonaAssociateConfirm" type="button">确认关联</button></div></footer></div></div>
          </div>
        </div>
      </section>`);})();
