    ...
    <div class="modal product-modal">
      ...
      <div class="modal-body">
        ...
        <section class="detail-section"><h3>关联资产</h3><div class="relation-tabs" role="tablist"><button class="active" type="button" data-relation-tab="copy">文案库</button><button type="button" data-relation-tab="image">图片库</button><button type="button" data-relation-tab="material">素材库</button><button type="button" data-relation-tab="script">脚本库</button><button type="button" data-relation-tab="video">视频库</button><button type="button" data-relation-tab="template">模板库</button></div>
          ...
          <div class="relation-panel" data-relation-panel="template"><div class="relation-row"><i></i><div><strong>清洁电器高点击口播提示词</strong><small>Agent 提示词 · 智能文案</small></div><button type="button" data-toast="已打开提示词模板">查看</button></div><div class="relation-row"><i></i><div><strong>结果冲击型 3 秒钩子</strong><small>爆款文案结构</small></div><button type="button" data-toast="已打开文案结构">查看</button></div><div class="relation-row"><i></i><div><strong>实拍演示主视频结构</strong><small>爆款视频结构</small></div><button type="button" data-toast="已打开视频结构">查看</button></div><div class="relation-row"><i></i><div><strong>清洁品类 TVC 策划画布</strong><small>无限画板模板</small></div><button type="button" data-toast="已打开无限画板模板">查看</button></div></div>
        </section>
      </div>
