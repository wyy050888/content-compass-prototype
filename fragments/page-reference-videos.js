(function(){
  ...
  s.insertAdjacentHTML('beforebegin',`<section class="page embedded-library-page" id="page-reference-videos"><iframe class="embedded-library-frame" src="embedded-pages/外部参考视频.html?v=20260811l" title="外部参考视频"></iframe></section>`);
