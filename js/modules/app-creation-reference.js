        ...
        audience: `<div class="rewrite-strategy-title"><strong>人群与表达策略</strong><span>重新定义改写文案面向的人群及使用语境</span></div>
          ...
          <div class="audience-selector rewrite-audience-selector">
            <div class="audience-selector-row"><span>抖音八大人群</span><div class="choice-row original-choices" data-rewrite-audience-box>
              <button class="rewrite-audience-chip" type="button">Z世代</button><button class="rewrite-audience-chip" type="button">精致妈妈</button><button class="rewrite-audience-chip" type="button">都市白领</button><button class="rewrite-audience-chip" type="button">都市银发</button><button class="rewrite-audience-chip" type="button">小镇中老年</button><button class="rewrite-audience-chip" type="button">小镇青年</button><button class="rewrite-audience-chip" type="button">新锐蓝领</button><button class="rewrite-audience-chip" type="button">资深中产</button>
            </div></div>
            <div class="audience-selector-row"><span>性别</span><div class="choice-row original-choices" data-single="rewrite-gender" data-role="rewrite-gender"><span class="choice-chip">不限</span><span class="choice-chip">男</span><span class="choice-chip">女</span></div></div>
            <div class="audience-selector-row"><span>年龄</span><div class="choice-row original-choices" data-single="rewrite-age" data-role="rewrite-age"><span class="choice-chip">18–23</span><span class="choice-chip">24–30</span><span class="choice-chip">31–40</span><span class="choice-chip">41–50</span><span class="choice-chip">51–60</span><span class="choice-chip">60+</span><span class="choice-chip" data-rewrite-custom-age-trigger>自定义</span><span class="custom-age-range" data-rewrite-custom-age hidden><input type="number" min="1" max="99" data-rewrite-age-min><i data-rewrite-age-separator>至</i><input type="number" min="1" max="99" data-rewrite-age-max><span data-rewrite-age-open-suffix hidden>岁及以上</span><button type="button" class="age-boundary-toggle" data-rewrite-age-boundary-toggle>设为以上</button><input type="checkbox" data-rewrite-age-plus hidden></span></div></div>
          </div>
          ...
          <div class="original-group">
            ...
            <div class="original-group-fields">
              ...
              <div class="original-field full advanced-field" hidden>
                <div class="original-field-head"><label>次要卖点</label><button class="ai-refresh" type="button" data-ai-suggest="secondary">AI 换一组</button></div>
            ...
            <div class="original-group-fields">
              ...
              <div class="original-field full">
                ...
                <div class="audience-selector">
                  <div class="audience-selector-row"><span>抖音八大人群</span><div class="choice-row original-choices" data-audience-box><button class="original-audience-chip audience-chip" type="button">Z世代</button><button class="original-audience-chip audience-chip" type="button">精致妈妈</button><button class="original-audience-chip audience-chip" type="button">都市白领</button><button class="original-audience-chip audience-chip" type="button">都市银发</button><button class="original-audience-chip audience-chip" type="button">小镇中老年</button><button class="original-audience-chip audience-chip" type="button">小镇青年</button><button class="original-audience-chip audience-chip" type="button">新锐蓝领</button><button class="original-audience-chip audience-chip" type="button">资深中产</button></div></div>
                  <div class="audience-selector-row"><span>性别</span><div class="choice-row original-choices" data-single="gender" data-role="gender"><span class="choice-chip">不限</span><span class="choice-chip">男</span><span class="choice-chip">女</span></div></div>
                  <div class="audience-selector-row"><span>年龄</span><div class="choice-row original-choices" data-single="age" data-role="age"><span class="choice-chip">18–23</span><span class="choice-chip">24–30</span><span class="choice-chip">31–40</span><span class="choice-chip">41–50</span><span class="choice-chip">51–60</span><span class="choice-chip">60+</span><span class="choice-chip" data-custom-age-trigger>自定义</span><span class="age-custom" data-custom-age hidden><input type="number" min="1" max="99" data-age-min><i data-age-separator>至</i><input type="number" min="1" max="99" data-age-max><span data-age-open-suffix hidden>岁及以上</span><button type="button" class="age-boundary-toggle" data-age-boundary-toggle>设为以上</button><input type="checkbox" data-age-plus hidden></span></div></div>
                </div>
              </div>
        ...
        <section class="original-step-panel" data-original-step="1" data-task-step="1">
          ...
          <div class="original-group">
            ...
            <div class="original-group-fields">
              ...
              <div class="original-field full advanced-field" hidden><div class="original-field-head"><label>次要卖点</label><button class="ai-refresh" type="button" data-ai-suggest="secondary">AI 换一组</button></div><div class="point-editor" data-point-editor="secondary" data-limit="3"><div class="point-row"><span class="point-index">●</span><input data-point-value value="透明尘杯可拆卸水洗"></div><div class="point-row"><span class="point-index">●</span><input data-point-value value="床垫、沙发和布艺均可使用"></div><button class="point-add" type="button" data-point-action="add">＋ 添加卖点</button><textarea data-field="secondary" hidden>透明尘杯可拆卸水洗\n床垫、沙发和布艺均可使用</textarea></div></div>
              <div class="original-field full advanced-field" hidden>
                <div class="original-field-head"><label>差异化卖点</label><button class="ai-refresh" type="button" data-ai-suggest="difference">AI 换一组</button></div>
                <div class="point-editor" data-point-editor="difference" data-limit="3">
                  <div class="point-row"><span class="point-index">●</span><input data-point-value value="清洁效果可视化，操作完成后尘杯清理方便"><span class="point-actions"><button type="button" data-point-action="up" title="上移">↑</button><button type="button" data-point-action="down" title="下移">↓</button><button type="button" data-point-action="remove" title="删除">×</button></span></div>
          ...
          <div class="original-group">
            ...
            <div class="original-group-fields">
              ...
              <div class="original-field full"><label>核心目标人群<span class="required-star">*</span></label><div class="audience-selector"><div class="audience-selector-row"><span>抖音八大人群</span><div class="choice-row original-choices" data-audience-box><button class="original-audience-chip audience-chip" type="button">Z世代</button><button class="original-audience-chip audience-chip" type="button">精致妈妈</button><button class="original-audience-chip audience-chip" type="button">都市白领</button><button class="original-audience-chip audience-chip" type="button">都市银发</button><button class="original-audience-chip audience-chip" type="button">小镇中老年</button><button class="original-audience-chip audience-chip" type="button">小镇青年</button><button class="original-audience-chip audience-chip" type="button">新锐蓝领</button><button class="original-audience-chip audience-chip" type="button">资深中产</button></div></div><div class="audience-selector-row"><span>性别</span><div class="choice-row original-choices" data-single="gender" data-role="gender"><span class="choice-chip">不限</span><span class="choice-chip">男</span><span class="choice-chip">女</span></div></div><div class="audience-selector-row"><span>年龄</span><div class="choice-row original-choices" data-single="age" data-role="age"><span class="choice-chip">18–23</span><span class="choice-chip">24–30</span><span class="choice-chip">31–40</span><span class="choice-chip">41–50</span><span class="choice-chip">51–60</span><span class="choice-chip">60+</span><span class="choice-chip" data-custom-age-trigger>自定义</span><span class="custom-age-range" data-custom-age hidden><input type="number" min="1" max="99" data-age-min><i data-age-separator>至</i><input type="number" min="1" max="99" data-age-max><span data-age-open-suffix hidden>岁及以上</span><button type="button" class="age-boundary-toggle" data-age-boundary-toggle>设为以上</button><input type="checkbox" data-age-plus hidden></span></div></div></div></div>
    ...
    agentConfigs.rewrite.form = `
      <div class="original-flow-form rewrite-flow-form">
        ...
        <section class="original-step-panel" data-original-step="2" data-task-step="2" hidden>
          ...
          <div class="original-group"><div class="original-group-fields">
            <div class="original-field full"><label>改写方式<span class="required-star">*</span></label><div class="choice-row original-choices" data-single="rewrite-method" data-role="rewrite-method"><span class="choice-chip active" data-rewrite-method="hook">只换前 3 秒钩子</span><span class="choice-chip" data-rewrite-method="shorten">缩短/扩写文案</span><span class="choice-chip" data-rewrite-method="audience">更换目标人群</span><span class="choice-chip" data-rewrite-method="selling">卖点前置</span><span class="choice-chip" data-rewrite-method="style">调整表达风格</span><span class="choice-chip" data-rewrite-method="rephrase">保留结构重新表达</span></div></div>
